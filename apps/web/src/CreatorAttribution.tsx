...
function dismissBadge(): void {
  try {
    ...
    // Ignore localStorage write failures (e.g. privacy mode / storage disabled)
  }
}

/**
 * Compact attribution card shown above the sidebar footer.
 * Displays creator avatar with ChatGPT icon subtly peeking out from the left edge.
 * Dismissing suppresses the card for 3 days across visits.
 */
  ...
  return (
    <div className="creator-attribution" role="region" aria-label="Creator attribution">
      ...
      >
        ...
        <div className="creator-avatar-group">
          <svg
